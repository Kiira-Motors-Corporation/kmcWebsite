    ...
    >
      <div style={{ transition: "all 0.3s ease" }} className="w-[600px] ">
        <div className="bg-white p-2 rounded-2xl flex flex-col py-5">
          ...
          <div onClick={handleLogout} className="border bg-red-600 gap-4 rounded-full py-2 px-[30px] text-white font-semibold focus:outline-none focus:ring focus:ring-red-700 ">
             Logout
            </div>
